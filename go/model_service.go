...
type Service struct {
	...
	ServiceAddress NullableString `json:"service_address,omitempty"`
...
func (o *Service) GetServiceAssetId() string {
	if o == nil || IsNil(o.ServiceAssetId) {
		var ret string
		return ret
	}
...
func (o *Service) GetServiceCreatedAt() int64 {
	if o == nil || IsNil(o.ServiceCreatedAt) {
		var ret int64
		return ret
	}
...
func (o *Service) GetServiceUpdatedAt() int64 {
	if o == nil || IsNil(o.ServiceUpdatedAt) {
		var ret int64
		return ret
	}
...
func (o *Service) SetServiceAddressNil() {
...
func (o *Service) GetServiceTransport() string {
	if o == nil || IsNil(o.ServiceTransport) {
		var ret string
		return ret
	}
...
func (o *Service) GetServiceSummary() string {
	if o == nil || IsNil(o.ServiceSummary) {
		var ret string
		return ret
	}
...
func (o *Service) GetServiceScreenshotLink() string {
	if o == nil || IsNil(o.ServiceScreenshotLink) {
		var ret string
		return ret
	}
...
func (o *Service) GetServicePortsProtocols() []string {
	if o == nil || IsNil(o.ServicePortsProtocols) {
		var ret []string
		return ret
	}
...
func (o *Service) GetServicePortsProducts() []string {
	if o == nil || IsNil(o.ServicePortsProducts) {
		var ret []string
		return ret
	}
...
func (o Service) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.ServicePortsProtocols) {
		toSerialize["service_ports_protocols"] = o.ServicePortsProtocols
	}
	if !IsNil(o.ServicePortsProducts) {
