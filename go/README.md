...
## Overview
This API client was generated by an experimental version of the [OpenAPI Generator](https://openapi-generator.tech) project using an older version of the YAML spec file. It is deprecated, and you are strongly recommended not to use it.

By using a current version of the [OpenAPI-spec](https://www.openapis.org/) `runzero-api.yml` YAML file (found in the root of this repository) with an up-to-date OpenAPI generator, you can easily generate an API client.
