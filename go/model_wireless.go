...
// checks if the Wireless type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &Wireless{}
...
func (o Wireless) ToMap() (map[string]interface{}, error) {
...
func (o *Wireless) UnmarshalJSON(data []byte) (err error) {
	...
	varWireless := _Wireless{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varWireless)

	if err != nil {
		return err
	}

	*o = Wireless(varWireless)
